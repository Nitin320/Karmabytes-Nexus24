...
import food4 from "../pics/food4.png"
import food5 from "../pics/food5.png"
import food6 from "../pics/food6.png"
    ...
    <div>
      <div className="z-10 fixed w-[100vw] h-[10vh] bg-[#013022] flex flex-row justify-between items-center gap-2 text-white text-[0.7rem]">
        ...
        <div className='flex flex-row justify-between content-center px-5 py-5'>
            <div className='flex flex-col h-[50vh] w-[25vw] gap-4 text-[0.8rem] p-3 bg-[#D9D9D9] rounded-md'>
                <Image src={food4} width={300} height={300}/>
                <div>
                    <div className='font-bold'>Fried Chicken</div>
                    <div className='font-bold'>80 plates</div>
                </div>
                <div>
                    <div>Authentic and traditional recipie made with love</div>
                    <div>Price per item : ₹12</div>
                </div>
                <div>
                    <div>Created: 2022-09-15</div>
                    <div>Expiry: 2022-09-23</div>
                </div>
            ...
            <div className='flex flex-col h-[50vh] w-[25vw] gap-4 text-[0.8rem] p-3 bg-[#D9D9D9] rounded-md'>
                <Image src={food5} width={300} height={300}/>
                <div>
                    <div className='font-bold'>Non-Veg Buffet</div>
                    <div className='font-bold'>100 Plates</div>
                </div>
                <div>
                    <div>Delicious and mouth watering food for your event</div>
                    <div>Price per item : ₹16</div>
                </div>
                <div>
                    <div>Created: 2022-09-05</div>
            ...
            <div className='flex flex-col h-[50vh] w-[25vw] gap-4 text-[0.8rem] p-3 bg-[#D9D9D9] rounded-md'>
                <Image src={food6} width={300} height={300}/>
                <div>
                    <div className='font-bold'>Boiled Eggs</div>
                    <div className='font-bold'>60 plates</div>
                </div>
                <div>
                    <div>Delicious and mouth watering food for your event</div>
                    <div>Price per item : ₹8</div>
                </div>
                <div>
                    <div>Created: 2022-10-10</div>
                    <div>Expiry: 2022-10-15</div>
                </div>
                <div className='flex flex-row justify-between content-center mt-[2vh] text-[#E4A71C] cursor-pointer'>
                    <div>Buy</div>
                    <div>Chat</div>
